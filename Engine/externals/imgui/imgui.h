...
namespace ImGui
{
    ...
    // Background/Foreground DrawParticle Lists
...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_Selected             = 1 << 0,   // DrawParticle as selected
    ImGuiTreeNodeFlags_Framed               = 1 << 1,   // DrawParticle frame with background (e.g. for CollapsingHeader)
...
enum ImGuiTableFlags_
{
    ...
    ImGuiTableFlags_BordersInnerH              = 1 << 7,   // DrawParticle horizontal borders between rows.
    ImGuiTableFlags_BordersOuterH              = 1 << 8,   // DrawParticle horizontal borders at the top and bottom.
    ImGuiTableFlags_BordersInnerV              = 1 << 9,   // DrawParticle vertical borders between columns.
    ImGuiTableFlags_BordersOuterV              = 1 << 10,  // DrawParticle vertical borders on the left and right sides.
    ImGuiTableFlags_BordersH                   = ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersOuterH, // DrawParticle horizontal borders.
    ImGuiTableFlags_BordersV                   = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersOuterV, // DrawParticle vertical borders.
    ImGuiTableFlags_BordersInner               = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersInnerH, // DrawParticle inner borders.
    ImGuiTableFlags_BordersOuter               = ImGuiTableFlags_BordersOuterV | ImGuiTableFlags_BordersOuterH, // DrawParticle outer borders.
    ImGuiTableFlags_Borders                    = ImGuiTableFlags_BordersInner | ImGuiTableFlags_BordersOuter,   // DrawParticle all borders.
...
// ImDrawCallback: DrawParticle callbacks for advanced uses [configurable type: override in imconfig.h]
// NB: You most likely do NOT need to use draw callbacks just to create your own widget or customized UI rendering,
// you can poke into the draw list for that! DrawParticle callback may be useful for example to:
...
// Special DrawParticle callback value to request renderer backend to reset the graphics/render state.
...
struct ImDrawListSplitter
{
    ...
    ImVector<ImDrawChannel>     _Channels;   // DrawParticle channels (not resized down so _Count might be < Channels.Size)
...
struct ImDrawList
{
    ...
    ImVector<ImDrawCmd>     CmdBuffer;          // DrawParticle commands. Typically 1 command = 1 GPU draw call, unless the command is a callback.
