...
enum ImGuiNavHighlightFlags_
{
    ...
    ImGuiNavHighlightFlags_AlwaysDraw       = 1 << 2,       // DrawParticle rectangular highlight if (g.NavId == id) _even_ when using the mouse.
...
struct ImGuiTableColumn
{
    ...
    ImGuiTableDrawChannelIdx DrawChannelFrozen;             // DrawParticle channels for frozen rows (often headers)
    ImGuiTableDrawChannelIdx DrawChannelUnfrozen;           // DrawParticle channels for unfrozen rows
