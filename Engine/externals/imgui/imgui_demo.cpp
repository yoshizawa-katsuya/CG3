    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("Word Wrapping"))
        {
            ...
            for (int n = 0; n < 2; n++)
            {
                ...
                // DrawParticle actual text bounding box, following by marker of our expected limit (should not overlap!)
...
static void ShowDemoWindowInputs()
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Dragging"))
        {
            ...
            if (ImGui::IsItemActive())
                ImGui::GetForegroundDrawList()->AddLine(io.MouseClickedPos[0], io.MousePos, ImGui::GetColorU32(ImGuiCol_Button), 4.0f); // DrawParticle a line between the button and the mouse cursor
...
static void ShowExampleAppLog(bool* p_open)
{
    ...
    // Most of the contents of the window will be added by the log.DrawParticle() call.
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            // DrawParticle a bunch of primitives
        ...
        if (ImGui::BeginTabItem("Canvas"))
        {
            ...
            // DrawParticle border and background color
            ImGuiIO& io = ImGui::GetIO();
            ImDrawList* draw_list = ImGui::GetWindowDrawList();
            ...
            // DrawParticle grid + all lines in the canvas
